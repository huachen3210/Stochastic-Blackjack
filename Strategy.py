...
if __name__ == "__main__":
    ...
    hard_table = strat_dict["hard"].to_csv("output/hard_table.csv")
    soft_table = strat_dict["soft"].to_csv("output/soft_table.csv")
    pair_table = strat_dict["pair"].to_csv("output/pair_table.csv")
